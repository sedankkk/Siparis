...
if(isset($_POST['add_to_cart'])){
   ...
   if($verify_cart->rowCount() > 0){
      $warning_msg[] = 'Zaten ekli!';
   }elseif($max_cart_items->rowCount() == 10){
      $warning_msg[] = 'Sepet dolu!';
   }else{
...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <input type="submit" name="add_to_cart" value="Ekle" class="btn">
      <a href="odeme.php?get_id=<?= $fetch_prodcut['id']; ?>" class="delete-btn">Hemen Al</a>
   </form>
   <?php
      }
   }else{
      echo '<p class="empty">Sipariş bulunamadı!</p>';
   }
   ?>
