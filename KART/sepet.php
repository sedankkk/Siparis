...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price">$</i> <?= $fetch_cart['price']; ?></p>
      ...
      <p class="sub-total">Toplam Tutar : <span>$</i> <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
      <input type="submit" value="sil" name="delete_item" class="delete-btn" onclick="return confirm('Silinsin mi?');">
   </form>
   <?php
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>Tutar : <span>$</i> <?= $grand_total; ?></span></p>
         <form action="" method="POST">
          <input type="submit" value="Boş Sepet" name="empty_cart" class="delete-btn" onclick="return confirm('empty your cart?');">
         </form>
         <a href="odeme.php" class="btn">Sipariş ver</a>
      </div>
   <?php } ?>
